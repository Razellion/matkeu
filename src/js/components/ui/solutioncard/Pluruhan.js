...
import {
  ...
  Persentase,
  LamaPeluruhan,
} from "../../../components/ui/form/peluruhanformtype";

const Pluruhan = ({ inputs, input, menu }) => {
  ...
  if (menu.name === "nilaiakhir") {
    ...
    res = resN;
  } else if (menu.name === "lamapeluruhan") {
    res = resW;
  ...
  var Temp_Lamapinjam = res.lamapeluruhan;
        ...
        <div className="flex justify-center p-4">
          <div>
            ...
            <div className="mt-4 text-sm text-white">
              ...
              <p>
                (5) {input.nilaiakhir} /{" "}
                {Math.pow(1 - Temp_Persentase, Temp_Lamapinjam).toFixed(2)} = N
                <sub>0</sub>
              </p>
              <p>
                (6) N<sub>0</sub> ={" "}
        ...
        <div className="flex justify-center p-4">
          <div>
            ...
            <div className="mt-4 text-sm text-white">
              ...
              <p>(7) -{res.hasil.toFixed(2)} = - p</p>
              <p>
                (8) p = {res.hasil.toFixed(2)} = {res.hasil.toFixed(2) * 100}%
              </p>
            </div>
          </div>
        </div>
